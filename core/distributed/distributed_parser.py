...
def _parse_spice_value(value_str: str) -> float:
    ...
    Thin wrapper that lazily delegates to pdn.pdn_parser._parse_spice_value
    to avoid circular imports (pdn.pdn_parser -> core -> core.distributed).
    """
    from pdn.pdn_parser import _parse_spice_value as _psv
