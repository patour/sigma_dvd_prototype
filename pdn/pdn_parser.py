...
# Instead of storing net_type string per node (~50 bytes), we store a small int index (~8 bytes)
...
# PDNNodeAttrs bit flag constants (module-level for slots=True compatibility)
