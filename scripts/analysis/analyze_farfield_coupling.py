...
Usage:
    python scripts/analysis/analyze_farfield_coupling.py --netlist ./netlist/netlist_test --net VDD
    python scripts/analysis/analyze_farfield_coupling.py --netlist ./netlist/netlist_test --net VDD --validate
    python scripts/analysis/analyze_farfield_coupling.py --netlist ./netlist/netlist_test --net VDD --sweep-position
    python scripts/analysis/analyze_farfield_coupling.py --netlist ./netlist/netlist_test --net VDD --sweep-size
"""
...
from analysis.farfield_analysis import (
...
from solver.tiling import TileManager
...
Examples:
  ...
  python scripts/analysis/analyze_farfield_coupling.py --netlist ./netlist/netlist_test --net VDD --distance-rings
        """
    )
