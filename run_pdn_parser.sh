...
#   ./run_pdn_parser.sh -p ./pdn/netlist_multi_tile       # Enable parallel parsing
#   ./run_pdn_parser.sh -p -w 8 ./pdn/netlist_multi_tile  # Parallel with 8 workers
#
# Options:
...
CMD="python ./pdn/pdn_parser.py --netlist-dir \"$NETLIST_DIR\" --net \"$NET_NAME\" --output \"$OUTPUT\" --verbose $PARALLEL $N_WORKERS $CHUNK_SIZE"
