...
from model.node_adapter import NodeInfoExtractor, UnifiedNodeInfo
from model.edge_adapter import EdgeInfoExtractor, UnifiedEdgeInfo, ElementType
...
class TestBackwardCompatibility(unittest.TestCase):
    ...
    def test_results_match_original(self):
        ...
        from legacy import PowerGridModel as OriginalPowerGridModel
