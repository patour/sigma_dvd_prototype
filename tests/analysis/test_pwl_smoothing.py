...
class TestCompactArrays(unittest.TestCase):
    ...
    def test_matches_compact_pwl(self):
        ...
        from analysis.pwl_smoothing import _compact_arrays
...
class TestPWLSmoother(unittest.TestCase):
    ...
    def test_disabled_smoother_passthrough(self):
        ...
        from parser.current_sources import PWL
    ...
    def test_smooth_pulse(self):
        ...
        from parser.current_sources import Pulse
...
class TestAnalyticalIntegralVectorized(unittest.TestCase):
    ...
    def test_matches_scalar_constant_segment(self):
        ...
        from analysis.pwl_smoothing import _analytical_integral_vectorized
...
class TestSmoothPWLVectorized(unittest.TestCase):
    ...
    def test_matches_scalar_constant_pwl(self):
        ...
        from analysis.pwl_smoothing import _smooth_pwl_vectorized
...
class TestChunkProcessing(unittest.TestCase):
    ...
    def test_pulse_to_pwl_arrays(self):
        ...
        from analysis.pwl_smoothing import _pulse_to_pwl_arrays
    ...
    def test_analytical_integral_batch_matches_vectorized(self):
        ...
        from analysis.pwl_smoothing import _analytical_integral_batch, _analytical_integral_vectorized
    ...
    def test_smooth_pulse_chunk_single_pulse(self):
        ...
        from analysis.pwl_smoothing import _smooth_pulse_chunk, _pulse_to_pwl_arrays
    ...
    def test_compact_chunk_vectorized(self):
        ...
        from analysis.pwl_smoothing import _compact_chunk_vectorized
    ...
    def test_compact_and_append(self):
        ...
        from analysis.pwl_smoothing import _compact_and_append
...
class TestPulseSmoothingVectorized(unittest.TestCase):
    ...
    def test_raw_vs_smoothed_pulses_vectorized(self):
        ...
        """
        from parser.current_sources import Pulse
        from analysis.pwl_smoothing import _smooth_pwl_vectorized, pulse_to_pwl_points
...
class TestPulseActiveIntervalDetection(unittest.TestCase):
    ...
    def test_simple_pulse_active_intervals(self):
        ...
        from analysis.pwl_smoothing import _compute_pulse_active_intervals
...
class TestPWLActiveIntervalDetection(unittest.TestCase):
    ...
    def test_constant_pwl_no_active_intervals(self):
        ...
        from analysis.pwl_smoothing import _compute_pwl_active_intervals
...
class TestSparseSmoothingFunctions(unittest.TestCase):
    ...
    def test_sparse_pulse_matches_dense(self):
        ...
        from analysis.pwl_smoothing import _smooth_pulse_chunk, _smooth_pulse_chunk_sparse, _pulse_to_pwl_arrays, _compute_pulse_active_intervals
    ...
    def test_sparse_pwl_matches_dense(self):
        ...
        from analysis.pwl_smoothing import _smooth_pwl_vectorized, _smooth_pwl_sparse
    ...
    def test_sparse_periodic_handling(self):
        ...
        from analysis.pwl_smoothing import _smooth_pwl_sparse, _smooth_pwl_vectorized
