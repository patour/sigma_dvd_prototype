...
from parser.current_sources import (
...
class TestNetlistParser(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        test_netlist_dir = Path(__file__).parent.parent.parent / 'netlist' / 'netlist_test'
...
class TestValidationOptimization(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        test_netlist_dir = Path(__file__).parent.parent.parent / 'netlist' / 'netlist_small'
        if not test_netlist_dir.exists():
    ...
    def test_optimized_shorts_matches_reference(self):
        ...
        from graph.rx_algorithms import node_connected_component
