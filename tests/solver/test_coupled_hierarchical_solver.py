...
class TestCoupledHierarchicalSolverSynthetic(unittest.TestCase):
    ...
    def test_result_structure(self):
        ...
        from model.factory import create_model_from_synthetic
        from solver.unified_solver import UnifiedIRDropSolver
        from solver.unified_solver import UnifiedCoupledHierarchicalResult
...
class TestSchurComplementOperator(unittest.TestCase):
    ...
    def test_schur_operator_matches_explicit(self):
        ...
        from model.factory import create_model_from_synthetic
        from solver.unified_solver import UnifiedIRDropSolver
        from solver.coupled_system import extract_block_matrices, SchurComplementOperator
...
class TestCoupledHierarchicalSolverPDN(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        prototype_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
        netlist_path = os.path.join(prototype_root, 'netlist', 'netlist_small')
...
class TestBlockMatrixExtraction(unittest.TestCase):
    ...
    def test_block_dimensions(self):
        ...
        from model.factory import create_model_from_synthetic
        from solver.coupled_system import extract_block_matrices
...
class TestAMGPreconditioner(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        from solver.coupled_system import HAS_PYAMG
    ...
    def test_amg_preconditioner_class_directly(self):
        ...
        from solver.coupled_system import AMGPreconditioner
        from solver.coupled_system import BlockMatrixSystem
        import scipy.sparse as sp
        import numpy as np
