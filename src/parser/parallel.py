...
# Import parsing helpers from actual sub-modules
from .spice_lexer import (
    R_TO_KOHM, C_TO_FF, L_TO_NH, I_TO_MA,
    _parse_spice_value, _check_net_filter,
)
from .current_sources import (
    _parse_pulse, _parse_pwl, _prepare_instance_source,
...
def _parse_instance_worker(args: Tuple) -> InstanceParseResult:
    ...
    """
    from .spice_lexer import _fast_instance_net_filter, _has_structured_instance_names
